...
public class Trapezio_View extends AbtractCRUDcli<Trapezio> implements ICRUDView<Trapezio> {
    ...
    public void read(Trapezio conta) {
        basic.ShowMsg("FIGURA: " + trapezio.getTipo() + "\n");
        basic.ShowMsg("ID: " + trapezio.getId() + "\n");
        basic.ShowMsg(trapezio.getDimensoes() + "\n");
        basic.ShowMsg("AREA: " + trapezio.getArea() + "\n");
        basic.ShowMsg("PERIMETRO: " + trapezio.getPerimetro() + "\n");
        basic.ShowMsg("DIAGONAL: " + trapezio.getDiagonal() + "\n");
        basic.ShowMsg("** \n");
    }
