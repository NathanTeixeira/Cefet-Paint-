...
public class Ponto_View extends AbtractCRUDcli<Ponto> implements ICRUDView<Ponto> {
    ...
    public void read(Ponto conta) {
        basic.ShowMsg("FIGURA: " + ponto.getTipo() + "\n");
        basic.ShowMsg("ID: " + ponto.getId() + "\n");
        basic.ShowMsg(ponto.getDimensoes() + "\n");
        basic.ShowMsg("AREA: " + ponto.getArea() + "\n");
        basic.ShowMsg("PERIMETRO: " + ponto.getPerimetro() + "\n");
        basic.ShowMsg("DIAGONAL: " + ponto.getDiagonal() + "\n");
        basic.ShowMsg("** \n");
    }
