...
public class Retangulo_View extends AbtractCRUDcli<Retangulo> implements ICRUDView<Retangulo> {
    ...
    public void read(Retangulo conta) {
        basic.ShowMsg("FIGURA: " + retangulo.getTipo() + "\n");
        basic.ShowMsg("ID: " + retangulo.getId() + "\n");
        basic.ShowMsg(retangulo.getDimensoes() + "\n");
        basic.ShowMsg("AREA: " + retangulo.getArea() + "\n");
        basic.ShowMsg("PERIMETRO: " + retangulo.getPerimetro() + "\n");
        basic.ShowMsg("DIAGONAL: " + retangulo.getDiagonal() + "\n");
        basic.ShowMsg("** \n");
    }
